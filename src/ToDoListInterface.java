...
public interface ToDoListInterface {
   ...
   * 
   * @return the next task or null if there are no tasks in the list or if all the
   *         tasks are complete.
   */
  public Task getWork();

  /**
   * Returns a copy of the tasks ArrayList, not a reference to the internal list
   * of tasks.
   * 
